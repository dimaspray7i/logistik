                            ...
                            @forelse ($orders as $order)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                        <a href="{{ route('admin.orders.show', $order) }}" class="text-info hover:underline">Lihat</a>
                                        <a href="{{ route('admin.orders.edit', $order) }}" class="text-warning hover:underline">Ubah</a>
