        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-soft sm:rounded-card border border-gray-100 p-6">
                ...
                <form method="POST" action="{{ route('admin.orders.store') }}" 
                      x-data="{
                          items: [{ product_id: '', quantity: 1, unit: 'Pcs', notes: '' }],
                          products: {{ Js::from($products->map(fn($p) => ['id' => $p->id, 'name' => $p->name, 'unit' => $p->unit])) }},
                          addItem() {
                              this.items.push({ product_id: '', quantity: 1, unit: 'Pcs', notes: '' });
                          },
                          removeItem(index) {
                    ...
                    <div class="space-y-4 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label for="customer_id" class="block text-sm font-medium text-gray-700">Pelanggan <span class="text-primary">*</span></label>
                    ...
                    <div class="flex items-center justify-end gap-4">
                        ...
                        <button type="submit" class="px-6 py-2 bg-primary text-white rounded-btn font-semibold hover:bg-red-700 transition">Simpan Pesanan</button>
                    </div>
                </form>
