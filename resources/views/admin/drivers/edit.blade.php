<x-app-layout>
    <x-slot name="header"><h2 class="font-poppins font-semibold text-xl text-gray-800 leading-tight">{{ __('Edit Driver') }}</h2></x-slot>
                ...
                <form method="POST" action="{{ route('admin.drivers.update', $driver) }}">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input id="name" type="text" name="name" value="{{ old('name', $driver->name) }}" required class="mt-1 block w-full rounded-btn border-gray-300 focus:border-primary focus:ring-primary shadow-sm @error('name') border-primary @enderror">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input id="phone" type="text" name="phone" value="{{ old('phone', $driver->phone) }}" required class="mt-1 block w-full rounded-btn border-gray-300 focus:border-primary focus:ring-primary shadow-sm @error('phone') border-primary @enderror">
                            ...
                            <div>
                                ...
                                <input id="license_number" type="text" name="license_number" value="{{ old('license_number', $driver->license_number) }}" class="mt-1 block w-full rounded-btn border-gray-300 focus:border-primary focus:ring-primary shadow-sm">
                            </div>
                        </div>
                        <div>
                    ...
                    <div class="mt-6 flex items-center justify-end gap-4">
                        ...
                        <button type="submit" class="px-6 py-2 bg-primary text-white rounded-btn font-semibold hover:bg-red-700 transition">Update Driver</button>
                    </div>
                </form>
            </div>
        </div>
