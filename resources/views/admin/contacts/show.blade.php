    ...
    <x-slot name="header">
        <div class="flex justify-between item-center">
            ...
            <a href="{{ route('admin.contacts.index') }}" 
               class="inline-flex item-center px-4 py-2 bg-gray-200 rounded-btn font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-300 transition">
                Back to List
            </a>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-soft sm:rounded-card border border-gray-100 p-6">
                ...
                <div class="flex item-center gap-4 mb-6">
                    <div class="w-14 h-14 rounded-full bg-primary flex item-center justify-center text-white font-poppins font-bold text-xl">
